  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-border bg-transparent text-foreground hover:bg-muted rounded",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80 rounded",
        ghost: "hover:bg-muted hover:text-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        // Custom luxury variants
        luxury: "bg-foreground text-background hover:bg-foreground/90 tracking-wider uppercase text-xs font-semibold rounded-none",
        "luxury-outline": "border border-foreground bg-transparent text-foreground hover:bg-foreground hover:text-background tracking-wider uppercase text-xs font-semibold rounded-none transition-all duration-300",
        "luxury-secondary": "bg-primary/10 text-primary hover:bg-primary/20 tracking-wider uppercase text-xs font-semibold rounded-none",
      },
      size: {
